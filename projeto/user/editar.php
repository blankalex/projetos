            ...
            <div class="centro empurra">
                ...
                <div class="linha">
                    ...
                    <div class="coluna coluna-6">
                        ...
                        <form id="formulario" name="formulario" action="editado.php" method="post" enctype="multipart/form-data" >
                            ...
                            <fieldset>
                                ...
                                <!--Para o adm-->
                                    ...
                                    ?>
                                            ...
                                            <h3>Não</h3>
                                            <input type="checkbox" name="adm" value="2"/>
                                    <?php
                                        }else{
                                    ?>  
                                ...
                                <input type="button" name="cancelar" class="acaoprev" value="Cancelar" onclick="location.href= 'perfil_usuario.php'">
