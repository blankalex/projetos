                    ...
                    $linhas = pg_num_rows($resultado);
                        ...
                        <div class="usuario_cadastrado_solo">
                            ...
                            <div class="usuario_cadastrado_solo_center">
                                ...
                                echo "<td>";
                                echo "<img src='../adm/fotos_perfil/" . $registro['foto_perfil'] . "' width='150px' heigth='150px'/>";
                                echo "</br></td>";
                                ...
                                echo "<td>";
                                echo "<a href=editar.php><input type='submit' value='Editar'></a>";
                                echo "</td>";
                                echo "<td>";
                                echo "<a href=deletar_user.php><input type='submit' value='Excluir'></a>";
                                echo "</td>";
                                echo "</tr>";
                                ?>
...
?>
                    ...
                    <br/><a href="index_usuario.php">Voltar</a>
                    </table>
