    ...
    <body>
        <div class="conteudo">
            ...
            <div id="linkjogo" class="linha fonte_jogos_borda">
                <h2 class="fonte_jogos">Meus Jogos</h2>
            </div>  
...
<?php
$sql_pegar_id_user_do_jogo_user = "select id_jogo, id_user, id_jogo_user
                            from jogo_user
                            order by id_jogo asc;";
$resultado_pegar_id_user_do_jogo_user = pg_query($conexao, $sql_pegar_id_user_do_jogo_user);
$linhas_pegar_id_user_do_jogo_user = pg_num_rows($resultado_pegar_id_user_do_jogo_user);
$registro_pegar_id_user_do_jogo_user = pg_fetch_array($resultado_pegar_id_user_do_jogo_user);

$id_user_do_jogo = $registro_pegar_id_user_do_jogo_user['id_user'];

$sql_pegar_jogo = "select id_jogo, nome_jogo
                                                from jogos join jogo_user using(id_jogo)
                                                where jogo_user.id_user = $id_user_do_jogo
                                                order by id_jogo asc;";
$resultado_pegar_jogo = pg_query($conexao, $sql_pegar_jogo);
$linhas_pegar_jogo = pg_num_rows($resultado_pegar_jogo);
