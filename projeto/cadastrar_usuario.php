...
if(isset($_GET['id_jogo'])){
    $id_jogo_escolhido=$_GET['id_jogo'];
        ...
        <div class="conteudo">
            ...
            <div class="centro empurra">
                ...
                <div class="linha">
                        ...
                        <div class="coluna coluna-2"><p class="espaço">Espaço</p></div>
                        ...
                        <div class="coluna coluna-8">
                            ...
                            <form id="formulario" name="formulario" action="cad_usuarios.php" method="post" enctype="multipart/form-data" >
                                ...
                                <fieldset>
                                    <h2>Cadastro</h2>
                                    <div class="sair_cadastro">
                                        <a href="index.php"><h3>X</h3></a>
                                    </div>
                                    
                                    <input class="estilo_input" placeholder="Login" type="text" required="" name="login" id="idlogin" style=" width: 100%;">
                                    <input class="estilo_input" placeholder="Senha" type="password" required="" name="senha" id="idsenha" style=" width: 100%;">
                                    <input class="estilo_input" placeholder="Repetir senha" type="password" required="" name="rep_senha" id="idrep_senha" style=" width: 100%;">
                                    <input type="hidden" name="id_jogo" value="<?php echo $id_jogo_escolhido ?>" id="id_jogo">                                     
                                ...
                                <fieldset>
                                    ...
                                    <input class="estilo_input" placeholder="Nome" type="text" required="" name="nome" id="idnome" style=" width: 100%;">
                                    <input class="estilo_input" placeholder="Sobrenome" type="text" required="" name="sobrenome" id="idsobrenome" style=" width: 100%;"> 
                                    <input class="estilo_input" placeholder="Data de nascimento" required="" type="date" name="data_nasc" id="iddata_nasc" style=" width: 100%;">
                                    <input class="estilo_input" placeholder="E-mail" type="email" required="" name="email" id="idemail" style=" width: 100%;"> 
                                ...
                                <fieldset>
                                    ...
                                    <input class="estilo_input" type="text" required="" name="url_steam" placeholder="Steam Community Link" id="idurl_steam" style="width: 100%">
                                    ...
                                    <input class="estilo_input escolher_foto" placeholder="Foto do perfil" class="texto_cadastro" type="file" required="" name="foto_perfil" style=" width: 100%;">
